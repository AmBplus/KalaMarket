...
namespace KalaMarket.EndPoint.Areas.Admin.Pages.HomePages.Sliders
{
    ...
    public class NewSliderModel : BasePageModel
    {
        ...
        {
            this.KalaMarketAggServices = kalaMarketAggServices;
        }
        
        [BindProperty]
        public SliderType SliderTypeProperty { get; set; } 
        [BindProperty]
        ...
        [MaxLength(length:KalaMarketConstants.MaxLength.Name*2, ErrorMessageResourceType = typeof(ErrorMessages),ErrorMessageResourceName = nameof(ErrorMessages.MaxLen))]
