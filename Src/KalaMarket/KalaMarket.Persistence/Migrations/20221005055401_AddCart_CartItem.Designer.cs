...
namespace KalaMarket.Persistence.Migrations
{
    ...
    [Migration("20221005055401_AddCart_CartItem")]
            ...
            modelBuilder.Entity("KalaMarket.Domain.Users.UserAgg.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            InsertTime = new DateTime(2022, 10, 5, 9, 24, 1, 123, DateTimeKind.Local).AddTicks(5663),
                            IsRemoved = false,
                            Name = "Admin",
                            UpdateTime = new DateTime(2022, 10, 5, 9, 24, 1, 123, DateTimeKind.Local).AddTicks(5612)
                        },
                        new
                        {
                            Id = 2L,
                            InsertTime = new DateTime(2022, 10, 5, 9, 24, 1, 123, DateTimeKind.Local).AddTicks(5719),
                            IsRemoved = false,
                            Name = "Operator",
                            UpdateTime = new DateTime(2022, 10, 5, 9, 24, 1, 123, DateTimeKind.Local).AddTicks(5712)
                        },
                        new
                        {
                            Id = 3L,
                            InsertTime = new DateTime(2022, 10, 5, 9, 24, 1, 123, DateTimeKind.Local).AddTicks(5736),
                            IsRemoved = false,
                            Name = "Customer",
                            UpdateTime = new DateTime(2022, 10, 5, 9, 24, 1, 123, DateTimeKind.Local).AddTicks(5730)
                        });
                });
