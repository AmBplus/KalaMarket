...
namespace KalaMarket.Persistence.Migrations
{
    ...
    [Migration("20221002112642_ChangeNameDbSetSlider")]
    partial class ChangeNameDbSetSlider
    {
            ...
            modelBuilder.Entity("KalaMarket.Domain.Users.UserAgg.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            InsertTime = new DateTime(2022, 10, 2, 14, 56, 42, 305, DateTimeKind.Local).AddTicks(2194),
                            IsRemoved = false,
                            Name = "Admin",
                            UpdateTime = new DateTime(2022, 10, 2, 14, 56, 42, 305, DateTimeKind.Local).AddTicks(2144)
                        },
                        new
                        {
                            Id = 2L,
                            InsertTime = new DateTime(2022, 10, 2, 14, 56, 42, 305, DateTimeKind.Local).AddTicks(2251),
                            IsRemoved = false,
                            Name = "Operator",
                            UpdateTime = new DateTime(2022, 10, 2, 14, 56, 42, 305, DateTimeKind.Local).AddTicks(2244)
                        },
                        new
                        {
                            Id = 3L,
                            InsertTime = new DateTime(2022, 10, 2, 14, 56, 42, 305, DateTimeKind.Local).AddTicks(2269),
                            IsRemoved = false,
                            Name = "Customer",
                            UpdateTime = new DateTime(2022, 10, 2, 14, 56, 42, 305, DateTimeKind.Local).AddTicks(2262)
                        });
                });
