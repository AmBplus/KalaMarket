...
namespace KalaMarket.Persistence.Migrations
{
    ...
    [Migration("20220913115734_AddBrand")]
            ...
            modelBuilder.Entity("KalaMarket.Domain.Entities.UserAgg.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsRemoved = false,
                            Name = "Admin",
                            UpdateTime = new DateTime(2022, 9, 13, 16, 27, 33, 914, DateTimeKind.Local).AddTicks(4255)
                        },
                        new
                        {
                            Id = 2L,
                            IsRemoved = false,
                            Name = "Operator",
                            UpdateTime = new DateTime(2022, 9, 13, 16, 27, 33, 914, DateTimeKind.Local).AddTicks(4363)
                        },
                        new
                        {
                            Id = 3L,
                            IsRemoved = false,
                            Name = "Customer",
                            UpdateTime = new DateTime(2022, 9, 13, 16, 27, 33, 914, DateTimeKind.Local).AddTicks(4429)
                        });
                });
