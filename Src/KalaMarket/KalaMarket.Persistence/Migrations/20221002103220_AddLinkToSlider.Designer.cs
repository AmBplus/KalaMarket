...
namespace KalaMarket.Persistence.Migrations
{
    ...
    [Migration("20221002103220_AddLinkToSlider")]
            ...
            modelBuilder.Entity("KalaMarket.Domain.Users.UserAgg.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            InsertTime = new DateTime(2022, 10, 2, 14, 2, 19, 851, DateTimeKind.Local).AddTicks(2004),
                            IsRemoved = false,
                            Name = "Admin",
                            UpdateTime = new DateTime(2022, 10, 2, 14, 2, 19, 851, DateTimeKind.Local).AddTicks(1944)
                        },
                        new
                        {
                            Id = 2L,
                            InsertTime = new DateTime(2022, 10, 2, 14, 2, 19, 851, DateTimeKind.Local).AddTicks(2145),
                            IsRemoved = false,
                            Name = "Operator",
                            UpdateTime = new DateTime(2022, 10, 2, 14, 2, 19, 851, DateTimeKind.Local).AddTicks(2136)
                        },
                        new
                        {
                            Id = 3L,
                            InsertTime = new DateTime(2022, 10, 2, 14, 2, 19, 851, DateTimeKind.Local).AddTicks(2165),
                            IsRemoved = false,
                            Name = "Customer",
                            UpdateTime = new DateTime(2022, 10, 2, 14, 2, 19, 851, DateTimeKind.Local).AddTicks(2158)
                        });
                });
