...
namespace KalaMarket.Persistence.Migrations
{
    ...
    [Migration("20220925162304_FixActivation")]
    partial class FixActivation
    {
            ...
            modelBuilder.Entity("KalaMarket.Domain.Entities.UserAgg.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            InsertTime = new DateTime(2022, 9, 25, 19, 53, 4, 375, DateTimeKind.Local).AddTicks(6304),
                            IsRemoved = false,
                            Name = "Admin",
                            UpdateTime = new DateTime(2022, 9, 25, 19, 53, 4, 375, DateTimeKind.Local).AddTicks(6244)
                        },
                        new
                        {
                            Id = 2L,
                            InsertTime = new DateTime(2022, 9, 25, 19, 53, 4, 375, DateTimeKind.Local).AddTicks(6384),
                            IsRemoved = false,
                            Name = "Operator",
                            UpdateTime = new DateTime(2022, 9, 25, 19, 53, 4, 375, DateTimeKind.Local).AddTicks(6355)
                        },
                        new
                        {
                            Id = 3L,
                            InsertTime = new DateTime(2022, 9, 25, 19, 53, 4, 375, DateTimeKind.Local).AddTicks(6403),
                            IsRemoved = false,
                            Name = "Customer",
                            UpdateTime = new DateTime(2022, 9, 25, 19, 53, 4, 375, DateTimeKind.Local).AddTicks(6397)
                        });
                });
