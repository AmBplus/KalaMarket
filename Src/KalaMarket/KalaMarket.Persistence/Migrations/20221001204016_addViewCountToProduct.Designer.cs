...
namespace KalaMarket.Persistence.Migrations
{
    ...
    [Migration("20221001204016_addViewCountToProduct")]
            ...
            modelBuilder.Entity("KalaMarket.Domain.Entities.UserAgg.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            InsertTime = new DateTime(2022, 10, 2, 0, 10, 15, 734, DateTimeKind.Local).AddTicks(7224),
                            IsRemoved = false,
                            Name = "Admin",
                            UpdateTime = new DateTime(2022, 10, 2, 0, 10, 15, 734, DateTimeKind.Local).AddTicks(7179)
                        },
                        new
                        {
                            Id = 2L,
                            InsertTime = new DateTime(2022, 10, 2, 0, 10, 15, 734, DateTimeKind.Local).AddTicks(7283),
                            IsRemoved = false,
                            Name = "Operator",
                            UpdateTime = new DateTime(2022, 10, 2, 0, 10, 15, 734, DateTimeKind.Local).AddTicks(7276)
                        },
                        new
                        {
                            Id = 3L,
                            InsertTime = new DateTime(2022, 10, 2, 0, 10, 15, 734, DateTimeKind.Local).AddTicks(7358),
                            IsRemoved = false,
                            Name = "Customer",
                            UpdateTime = new DateTime(2022, 10, 2, 0, 10, 15, 734, DateTimeKind.Local).AddTicks(7352)
                        });
                });
