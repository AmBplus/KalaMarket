...
namespace KalaMarket.Persistence.Migrations
{
    ...
    [Migration("20220925100041_AddIsActiveToBrands")]
    partial class AddIsActiveToBrands
    {
            ...
            modelBuilder.Entity("KalaMarket.Domain.Entities.UserAgg.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            InsertTime = new DateTime(2022, 9, 25, 13, 30, 41, 129, DateTimeKind.Local).AddTicks(4110),
                            IsRemoved = false,
                            Name = "Admin",
                            UpdateTime = new DateTime(2022, 9, 25, 13, 30, 41, 129, DateTimeKind.Local).AddTicks(4047)
                        },
                        new
                        {
                            Id = 2L,
                            InsertTime = new DateTime(2022, 9, 25, 13, 30, 41, 129, DateTimeKind.Local).AddTicks(4170),
                            IsRemoved = false,
                            Name = "Operator",
                            UpdateTime = new DateTime(2022, 9, 25, 13, 30, 41, 129, DateTimeKind.Local).AddTicks(4162)
                        },
                        new
                        {
                            Id = 3L,
                            InsertTime = new DateTime(2022, 9, 25, 13, 30, 41, 129, DateTimeKind.Local).AddTicks(4196),
                            IsRemoved = false,
                            Name = "Customer",
                            UpdateTime = new DateTime(2022, 9, 25, 13, 30, 41, 129, DateTimeKind.Local).AddTicks(4188)
                        });
                });
