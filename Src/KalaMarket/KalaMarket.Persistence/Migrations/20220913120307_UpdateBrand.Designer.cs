...
namespace KalaMarket.Persistence.Migrations
{
    ...
    [Migration("20220913120307_UpdateBrand")]
            ...
            modelBuilder.Entity("KalaMarket.Domain.Entities.UserAgg.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsRemoved = false,
                            Name = "Admin",
                            UpdateTime = new DateTime(2022, 9, 13, 16, 33, 7, 466, DateTimeKind.Local).AddTicks(5418)
                        },
                        new
                        {
                            Id = 2L,
                            IsRemoved = false,
                            Name = "Operator",
                            UpdateTime = new DateTime(2022, 9, 13, 16, 33, 7, 466, DateTimeKind.Local).AddTicks(5566)
                        },
                        new
                        {
                            Id = 3L,
                            IsRemoved = false,
                            Name = "Customer",
                            UpdateTime = new DateTime(2022, 9, 13, 16, 33, 7, 466, DateTimeKind.Local).AddTicks(5587)
                        });
                });
