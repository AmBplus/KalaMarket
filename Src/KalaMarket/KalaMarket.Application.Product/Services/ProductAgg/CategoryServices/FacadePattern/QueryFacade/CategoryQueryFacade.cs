...
using KalaMarket.Application.Product.Services.ProductAgg.CategoryServices.Queries.GetCategoryWithAllParent;
using KalaMarket.Application.Product.Services.ProductAgg.CategoryServices.Queries.GetCategoryWithChild;
using KalaMarket.Application.Product.Services.ProductAgg.CategoryServices.Queries.GetCategoryWithParent;
using KalaMarket.Application.Product.Services.ProductAgg.CategoryServices.Queries.GetCategoryWithParentChild;

namespace KalaMarket.Application.Product.Services.ProductAgg.CategoryServices.FacadePattern.QueryFacade;
