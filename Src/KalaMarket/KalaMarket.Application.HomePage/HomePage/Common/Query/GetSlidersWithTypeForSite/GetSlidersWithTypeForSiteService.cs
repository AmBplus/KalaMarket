...
public class GetSlidersWithTypeForSiteService : IGetSlidersWithTypeForSiteService
{
    ...
    public GetSlidersWithTypeForSiteService(IKalaMarketContext context, ILoggerManger logger)
    {
        Context = context;
        Logger = logger;
        Result = new ResultDto<ResultGetSlidersWithTypeForSiteDto>(new ResultGetSlidersWithTypeForSiteDto(){Sliders = new List<GetSlidersWithTypeForSiteDto>()});
    }
    ...
    public async Task<ResultDto<ResultGetSlidersWithTypeForSiteDto>> ExecuteAsync(RequestGetSlidersWithTypeForSiteDto request)
    {
