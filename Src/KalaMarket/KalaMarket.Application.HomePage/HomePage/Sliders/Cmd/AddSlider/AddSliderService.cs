...
public class AddSliderService : IAddSliderService
{
    ...
    public ResultDto Execute(RequestAddSliderServiceDto request)
    {
        ...
        if (Result.IsSuccess)
        {
            Logger.LogInformation("مین اسلایدر جدید ساخته شد");
        }
        return Result;
    }
    ...
    {
        ValidationRequestAddSliderServiceDto validationRequestAddSliderServiceDto = new ValidationRequestAddSliderServiceDto();
