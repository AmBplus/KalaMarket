...
using KalaMarket.Application.ShopManagement.Validations.Brand;
...
public class AddBrandService : IAddBrandService
{
    ...
    {
        var result = new ResultDto<AddBrandServiceDto>(null);
        // Validate Request 
    ...
    private bool ValidationRequestAddBrand(ResultDto<AddBrandServiceDto> result, RequestAddBrand requestAddBrand)
    {
        ...
        return resultValidate.ValidateResultHasError(result);
    }
}