        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SliderType = table.Column<byte>(type: "tinyint", nullable: false),
                    UpdateTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsRemoved = table.Column<bool>(type: "bit", nullable: false),
                    RemoveTime = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, false, "Admin", null, new DateTime(2022, 12, 5, 22, 52, 6, 128, DateTimeKind.Local).AddTicks(113) });

            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "IsRemoved", "Name", "RemoveTime", "UpdateTime" },
                values: new object[] { 2L, false, "Operator", null, new DateTime(2022, 12, 5, 22, 52, 6, 128, DateTimeKind.Local).AddTicks(491) });

            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "IsRemoved", "Name", "RemoveTime", "UpdateTime" },
                values: new object[] { 3L, false, "Customer", null, new DateTime(2022, 12, 5, 22, 52, 6, 128, DateTimeKind.Local).AddTicks(527) });
