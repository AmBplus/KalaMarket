    ...
    public partial class initAgain : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, false, "Admin", null, new DateTime(2022, 11, 12, 17, 9, 36, 886, DateTimeKind.Local).AddTicks(5775) });

            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "IsRemoved", "Name", "RemoveTime", "UpdateTime" },
                values: new object[] { 2L, false, "Operator", null, new DateTime(2022, 11, 12, 17, 9, 36, 886, DateTimeKind.Local).AddTicks(6082) });

            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "IsRemoved", "Name", "RemoveTime", "UpdateTime" },
                values: new object[] { 3L, false, "Customer", null, new DateTime(2022, 11, 12, 17, 9, 36, 886, DateTimeKind.Local).AddTicks(6104) });
