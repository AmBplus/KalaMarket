...
public class UserCommandFacadeService : IUserCommandFacadeService
{
    ...
    public IChangeRemoveUserService ChangeRemoveUserService => _changeRemoveUserService ??= new ChangeRemoveUserService(Context, Logger);
    public IEditUserService EditUserService => _editUserService ??= new EditUserService(Context, Logger);
    public IRegisterUserService RegisterUserService => _registerUserService ??= new RegisterUserService(Context, Logger);
