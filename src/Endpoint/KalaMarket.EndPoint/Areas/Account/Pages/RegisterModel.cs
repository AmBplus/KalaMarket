...
public class RegisterModel : BasePageModel
{
    ...
    public RegisterModel(IGetRoleService roleService, IRegisterUserService registerUserService,
        ILoggerManger<RegisterModel> logger)
    {
    ...
    [BindProperty] public RegisterCustomerViewModel RegisterUser { get; set; }
    ...
    public void OnGet()
    {
        ...
        if (roleId == null) throw new Exception("با پشتبانی تماس حاصل فرمایید");
        RegisterUser = new RegisterCustomerViewModel();
