                        ...
                        const circle = new Chartist.Svg("circle",
                            {
                                ...
                                cy: data.y,
                                r: circleRadius,
                                class: data.value.y === 3 || data.value.y === 45
