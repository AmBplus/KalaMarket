...
(function(window, document, $) {
    ...
    $(document).ready(function() {
        ...
        ******************************/
        ...
        $(".add-tagging").on("click",
            function() {
                $(".add-box").tagging("add", "Sydney");
            });

        $(".remove-tagging").on("click",
            function() {
                $(".remove-box").tagging("remove", "cairo");
            });

        $(".remove-all-tagging").on("click",
            function() {
                removeAll.tagging("removeAll");
            });

        $(".refresh-tagging").on("click",
            function() {
                refresh.tagging("refresh");
            });

        $(".reset-tagging").on("click",
            function() {
                reset.tagging("reset");
            });

        $(".destroy-tagging").on("click",
            function() {
