...
(function(window, document, $) {
    ...
    $(document).ready(function() {
        ...
        ***************************************************************/
        ...
        // DataTable
        const tableSearching = $(".text-inputs-searching").DataTable();
        ...
        ********************************************************************/
        ...
        function format(d) {
            ...
            return `<table cellpadding="5" cellspacing="0" border="0" style="padding-left:50px;"><tr><td>Full name:</td><td>${
                d.name
                }</td></tr><tr><td>Extension number:</td><td>${d.extn
        ...
        $(".show-child-rows tbody").on("click",
            "td.details-control",
            function() {
                const tr = $(this).closest("tr");
                const row = tableChildRows.row(tr);
        ...
        ***************************************************/
        ...
        $(".selection-multiple-rows tbody").on("click",
            "tr",
            function() {
        ...
        *************************************************************/
        ...
        $(".selection-deletion-row tbody").on("click",
            "tr",
            function() {
        ...
        *********************************/
        ...
        $(".inputs-submin").on("click",
            function() {
                const data = tableFormInputs.$("input, select").serialize();
                alert(
        ...
        *****************************************************/
        ...
        $("a.toggle-vis").on("click",
            function(e) {
                ...
                const column = tableDynamically.column($(this).attr("data-column"));
