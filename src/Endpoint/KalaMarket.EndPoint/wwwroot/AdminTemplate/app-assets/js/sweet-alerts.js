...
(function(window, document, $) {
    ...
    $(document).ready(function() {
        ...
        $("#type-question").on("click",
            function() {
                swal("Question", "Are You Sure?", "question").done();
            });

        $("#type-success").on("click",
            function() {
