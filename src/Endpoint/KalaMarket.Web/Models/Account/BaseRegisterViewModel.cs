...
public class BaseRegisterViewModel
{
    ...
    [RegularExpression(KalaMarketConstants.RegularExpression.Password,
        ErrorMessageResourceName = nameof(ErrorMessages.UnValidPassword),
        ErrorMessageResourceType = typeof(ErrorMessages))]
    [Required(AllowEmptyStrings = false, ErrorMessageResourceType = typeof(ErrorMessages)
        , ErrorMessageResourceName = nameof(ErrorMessages.RequiredWithFieldName))]
    [DataType(DataType.Password)]
    [StringLength(KalaMarketConstants.MaxLength.Password, MinimumLength
            = KalaMarketConstants.MinLength.Password, ErrorMessageResourceName = nameof(ErrorMessages.OutofMinMax),
        ErrorMessageResourceType = typeof(ErrorMessages))]
