...
using KalaMarket.Infrastructure.Identity;
using KalaMarket.Infrastructure.ShopManagement;
...
try
{
    ...
    builder.Services.AddAuthentication(op => { op.DefaultAuthenticateScheme = SecurityUtility.AuthenticationScheme; })
        .AddCookie(option =>
        {
