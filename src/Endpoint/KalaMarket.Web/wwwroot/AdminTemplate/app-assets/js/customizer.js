...
(function(window, document, $) {
    ...
    $(document).ready(function() {
        ...
        ********************************/
        const body = $("body");
        const default_bg_color = $(".app-sidebar").attr("data-background-color");
        const default_bg_image = $(".app-sidebar").attr("data-image");
        ...
        $(".customizer-toggle").on("click",
            function() {
                $(".customizer").toggleClass("open");
            });
        $(".customizer-close").on("click",
            function() {
        ...
        $(".cz-sidebar-width").on("change",
            function() {
                const $this = $(this);
                const width_val = this.value;
