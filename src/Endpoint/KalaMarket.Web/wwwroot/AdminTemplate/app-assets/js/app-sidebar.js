...
(function(window, document, $) {
    ...
    $(document).ready(function() {
        ...
        const $sidebar_img = $sidebar.data("image");
        const $sidebar_img_container = $(".sidebar-background");
        var $wrapper = $(".wrapper");
        ...
        function collapse($listItem, callback) {
            const $subList = $listItem.children("ul");
        ...
        $(".logo-text").on("click",
            function() {
                ...
                const listItem = $sidebar_content.find("li.open.has-sub");
                const activeItem = $sidebar_content.find("li.active");
        ...
        $(".nav-toggle").on("click",
            function() {
                const $this = $(this);
                const toggle_icon = $this.find(".toggle-icon");
                const toggle = toggle_icon.attr("data-toggle");
                const compact_menu_checkbox = $(".cz-compact-menu");
        ...
        $sidebar.on("mouseenter",
            function() {
                if ($wrapper.hasClass("nav-collapsed")) {
                    ...
                    const $listItem = $(".navigation li.nav-collapsed-open");
                    const $subList = $listItem.children("ul");

                    $subList.hide().slideDown(300,
                        function() {
                            $(this).css("display", "");
                        });
            ...
            function(event) {
                if ($wrapper.hasClass("nav-collapsed")) {
                    ...
                    const $listItem = $(".navigation li.open");
                    const $subList = $listItem.children("ul");
                    $listItem.addClass("nav-collapsed-open");

                    $subList.show().slideUp(300,
                        function() {
                            $(this).css("display", "");
                        });
