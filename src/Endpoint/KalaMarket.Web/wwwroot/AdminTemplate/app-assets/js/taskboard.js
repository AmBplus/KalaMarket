...
(function(window, document, $) {
    ...
    $(document).ready(function() {
        // Draggable Cards
        dragula([
            document.getElementById("drag-todos"), document.getElementById("drag-in-progress"),
            document.getElementById("drag-completed"), document.getElementById("drag-on-hold")
        ]);
