...
!function(t) {
    ...
    var e = -1,
        ...
        a = function(e) {
            ...
            return a.each(function() {
                const e = t(this);
                const a = e.offset().top - i(e.css("margin-top"));
                const s = r.length > 0 ? r[r.length - 1] : null;
                null === s ? r.push(e) : Math.floor(Math.abs(n - a)) <= o ? r[r.length - 1] = s.add(e) : r.push(e), n =
                    a;
            }), r;
        },
        n = function(e) {
        ...
        r = t.fn.matchHeight = function(e) {
            ...
            if (o.remove) {
                var i = this;
                return this.css(o.property, ""), t.each(r._groups, function(t, e) { e.elements = e.elements.not(i) }),
                    this;
            }
    ...
    r.version = "0.7.0", r._groups = [], r._throttle = 80, r._maintainScroll = !1, r._beforeUpdate = null,
        r._afterUpdate = null, r._rows = a, r._parse = i, r._parseOptions = n, r._apply = function(e, o) {
            ...
            const d = h.parents().filter(":hidden");
                    ...
                    function(e, o) {
                        ...
                        if (s.target) n = s.target.outerHeight(!1);
                            ...
                            a.each(function() {
                                ...
                                a[s.property] =
                                    "", e.css(a), e.outerHeight(!1) > n && (n = e.outerHeight(!1)), o
                                    ? e.attr("style", o)
                                    : e.css("display", "");
                            });
                        }
                        a.each(function() {
                            ...
                            (o += i(e.css("border-top-width")) + i(e.css("border-bottom-width")), o += i(
                                    e.css("padding-top")) +
                                i(e.css("padding-bottom"))), e.css(s.property, n - o + "px"));
                        });
                    }), d.each(function() {
                    const e = t(this);
            ...
            t("[data-match-height], [data-mh]").each(function() {
                const o = t(this);
                const i = o.attr("data-mh") || o.attr("data-match-height");
