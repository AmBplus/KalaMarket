...
public class GetProductsForSiteService : IGetProductsForSiteService
{
    ...
    private IQueryable<GetProductForSiteDto> SelectAndPagination(IQueryable<Domain.Products.ProductAgg.Product> query,
    ...
    private IQueryable<Domain.Products.ProductAgg.Product> WhereSearchKeyNotNull(
        IQueryable<Domain.Products.ProductAgg.Product> query, string? requestSearchKey)
    {
    ...
    private IQueryable<Domain.Products.ProductAgg.Product> WhereCategoryIdIsNotNull(
        IQueryable<Domain.Products.ProductAgg.Product> query, long? categoryId)
    {
    ...
    private IQueryable<Domain.Products.ProductAgg.Product> OrderBy(IQueryable<Domain.Products.ProductAgg.Product> query,
